...
<template>
  <section
    class="relative flex h-full flex-1 items-center justify-center overflow-hidden bg-black"
  >
    <div
    ...
    <div class="pointer-events-none z-10 text-center select-none">
      <h2 class="text-4xl font-black tracking-tighter opacity-20">PREVIEW</h2>
    </div>
  </section>
</template>
